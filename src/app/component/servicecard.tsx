...
const ServiceCard: React.FC<{ service: ServiceType }> = ({ service }) => {
    ...
    return (
        <div className="service-card bg-white rounded-lg shadow-md overflow-hidden h-full relative grid grid-cols-12 gap-4">
            ...
            <div className="service-card_content col-span-8  py-0 md: pt-4">
                <h4 className="service-card_title font-bold text-md md:text-xl mt-0">
                    <Link href="">{title}</Link>
                </h4>

                <button className="inline-flex items-center text-sm  text-red font-bold absolute bottom-2">
                    Book Apointment
