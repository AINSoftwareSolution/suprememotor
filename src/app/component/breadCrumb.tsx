...
const Breadcrumb: React.FC<{ paths: PathType[], title:string }> = ({ paths , title}) => {
    return (
        <div
            className="bg-cover bg-center bg-bottom bg-no-repeat bg-scroll"
            style={{
                backgroundImage: `url('https://fixturbowp.wowtheme7.com/wp-content/uploads/2024/03/Screenshot_6.png')`,
            }}
        >
            <div className="container mx-auto max-w-screen-xl px-4 py-20 text-white">
                <div className="mt-24">
