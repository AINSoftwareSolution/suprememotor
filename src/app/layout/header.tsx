                 ...
                 ${isActive ? "bg-dark py-4 shadow-md" : "bg-none py-6"} `}>
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        <Link href="/" className="flex items-center">
                            <Image src={Logo}
                                className="mr-3"
                                alt="car repair in pune"
                                width={100}
                                height={100} />
                        </Link>
                        <div className="flex items-center lg:d-none">
                        ...
                        <div className={`${!collapse ? 'hidden' : 'block bg-dark'} justify-between items-center w-full lg:flex lg:w-auto lg:order-1`}
                            id="mobile-menu-2">
                            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                ...
                                <li>
                                    <button
                                        ...
                                        className="text-white bg-red  font-medium rounded-lg text-sm px-4  my-2
                            lg:px-5 py-2 lg:py-2.5 lg:my-0 mr-2 focus:outline-none">Book Apointment</button>
                                </li>
                            </ul>
                        </div>
                    </div>
