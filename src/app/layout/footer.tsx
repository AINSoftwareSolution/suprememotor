            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div>
                        ...
                        <div className="text-gray-500 font-medium">
                            <p className="mb-4">Mohammed Wadi, NIBM Annexe, Opposite Star Bazaar</p>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <Link href="#" className="text-gray-500 hover:text-red ms-5">
                        ...
                        <Link href="#" className="text-gray-500 hover:text-red ms-5">
                            <svg className="w-3 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 17">
